...
class Quotes : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.team08.cs.R.layout.activity_quotes)
        ...
        val myRBtn: ImageButton = findViewById(com.team08.cs.R.id.relationship_btn)
        val myFBtn: ImageButton = findViewById(com.team08.cs.R.id.Friendship_btn2)
        val myLBtn: ImageButton = findViewById(com.team08.cs.R.id.life_btn3)
        this.title = getString(com.team08.cs.R.string.title_activity_quotes)
